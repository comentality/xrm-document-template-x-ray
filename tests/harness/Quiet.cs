...
{
    /// <summary>
    /// The window the harness hosts the control in.
    ///
    ...
    ///
    /// Set DTX_HARNESS_ONSCREEN=1 to put them back in front. That is for watching a scenario
    ...
    public class QuietForm : Form
    {
        ...
        {
            get { return Environment.GetEnvironmentVariable("DTX_HARNESS_ONSCREEN") == "1"; }
        }
